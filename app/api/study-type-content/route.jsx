...
// 🔥 FIXED: Type mapping functions to match study-type API expectations
function mapStudyTypeForInngest(frontendType) {
    const typeMapping = {
        'notes': 'Notes',
        'flashcards': 'Flashcard',
...
function mapStudyTypeForDatabase(frontendType) {
    const typeMapping = {
        'notes': 'notes',        // 🔥 FIXED: Store as 'notes' to match study-type API
        'flashcards': 'flashcards', // 🔥 FIXED: Store as 'flashcards' to match study-type API
        'quiz': 'quiz',          // 🔥 FIXED: Store as 'quiz' to match study-type API
        'qa': 'qa',              // 🔥 FIXED: Store as 'qa' to match study-type API
    };
    return typeMapping[frontendType] || frontendType;
}
...
export async function POST(req) {
    try {
        ...
        console.log("🚀 Generating content for:", { type, courseId, chapters, databaseType });
