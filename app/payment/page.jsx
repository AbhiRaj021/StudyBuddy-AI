...
//                     <div className="lg:w-2/5 bg-gray-50 p-8 border-r border-gray-200">
//                         <div className="mb-8">
//                             <div className="flex items-center mb-6">
//                                 <ArrowLeft className="w-5 h-5 mr-3 text-gray-600" />
//                                 <span className="text-2xl font-semibold">StudyBuddy AI</span>
//                             </div>

//                             <h2 className="text-lg font-medium text-gray-900 mb-2">
//                                 Subscribe to StudyBuddy AI Plus Subscription
//                             </h2>

//                             <div className="mb-6">
//                                 <span className="text-3xl font-bold text-gray-900">$8.00</span>
...
//                                 <div>
//                                     <div className="font-medium text-gray-900">StudyBuddy AI Plus Subscription</div>
//                                     <div className="text-sm text-gray-600">Billed monthly</div>
//                                 </div>
//                                 <div className="font-medium text-gray-900">$8.00</div>
//                             </div>
//                         </div>
...
//                             </div>
//                             <span className="text-sm text-gray-600">Enter address to calculate</span>
//                         </div>
...
//                                                 <div className="w-8 h-5 bg-orange-400 rounded text-white text-xs flex items-center justify-center font-bold">DC</div>
//                                             </div>
//                                         </div>
//                                         <div className="flex">
//                                             <input
...
//                                                 onChange={handleInputChange}
//                                                 className="flex-1 px-3 py-2 border-none outline-none border-r border-gray-300"
//                                             />
...
//                                         />
//                                     </div>
//                                     <button type="button" className="text-sm text-blue-600 hover:text-blue-800 mt-2">
...
//                                             <div className="text-gray-600">Pay faster on OpenAI, LLC and everywhere Link is accepted.</div>
//                                         </div>
//                                     </label>
...
//                                             className="mr-3"
//                                         />
//                                         <span className="text-sm text-gray-900">I'm purchasing as a business</span>
//                                     </label>
//                                 </div> */}

//                                 {/* Terms */}
//                                 {/* <div className="text-xs text-gray-600 mb-6 leading-relaxed">
//                                     You'll be charged the amount and at the frequency listed above until you cancel. We may change our prices as described in our{' '}
//                                     <a href="#" className="text-blue-600 hover:text-blue-800">Terms of Use</a>. You can{' '}
//                                     <a href="#" className="text-blue-600 hover:text-blue-800">cancel any time</a>. By subscribing, you agree to OpenAI's{' '}
//                                     <a href="#" className="text-blue-600 hover:text-blue-800">Terms of Use</a> and{' '}
//                                     <a href="#" className="text-blue-600 hover:text-blue-800">Privacy Policy</a>, and you authorize us to store your payment method for renewals and other purchases.
//                                 </div> */}
